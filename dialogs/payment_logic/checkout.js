...
var PaymentToken = require('./payment_token');
var payments = require('./payments');

function validateAndCalculateDetails(paymentRequest) {
    ...
    return new Promise ((res, rej) => {
        var paymentDetails = {
            total: {
                label: 'Total',
                amount: { currency: 'USD', value: 34 }
            }
        };
        res(_.assign({}, paymentRequest, { details: paymentDetails }));
    });
}
